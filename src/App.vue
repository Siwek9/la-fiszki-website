<template>
  ...
  <NewCardboard ref="cardboardArrayObject" @deleteCardboard="deleteCardboard" @nextCardboard="moveToNextCardboard"
    @inputFrontChanged="inputFrontChanged" @inputBackChanged="inputBackChanged" v-for="cardboard in cardboards"
    :side-name="side_name" :key="cardboard.id" :cardboard-data="cardboard" />
